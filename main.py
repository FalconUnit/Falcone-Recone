...
def main():
    try:
        ...
        while True:
            ...
            section = Prompt.ask("[bold yellow]Enter your choice (0/1/2)[/bold yellow]")
            ...
            if section == '1':
                ...
                choice = Prompt.ask("[bold yellow]Enter your choice (0–8)[/bold yellow]")
                ...
                console.print("[cyan]0.[/cyan] Back to Main Menu\n")
                choice = Prompt.ask("[bold yellow]Enter your choice (0, 9–15)[/bold yellow]")
                ...
                console.print("[red]Invalid input. Please select 1 or 2.[/red]")

    except KeyboardInterrupt:
        console.print("\n[red]⛔ Scan interrupted by user (CTRL+C). Please restart the tool to begin again.[/red]")
